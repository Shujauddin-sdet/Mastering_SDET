...
let botName = "Shujauddin";
let botLocation = "Bangaloere";
let favoriteLanguage = "Javascript";

console.log("My name is " + botName + " and I live on " + botLocation + ".");
console.log("My favorite programming language is " + favoriteLanguage + ".");

let codingFact = "js is funny";
codingFact = "hey new fact "+ favoriteLanguage;
console.log(codingFact);

codingFact =  "wow " + favoriteLanguage;
console.log(codingFact);

codingFact =  " three " + favoriteLanguage;
console.log(codingFact);
